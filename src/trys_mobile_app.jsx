...
export default function TrysApp() {
        ...
        <div style={{ 
          ...
          {thread.open && (
            <ChevronLeft 
              ...
              onClick={() => setThread({ open: false, i: 0 })} 
            />
          )}
          <h1 style={{
            ...h1,
        ...
        {!thread.open ? (
          ...
          <div style={{ marginTop: 16, display: "flex", flexDirection: "column", gap: 8 }}>
              ...
              {bubbles.map((m, i) => (
                <div 
                  ...
                  style={{ 
                    ...
                    background: m.me ? violet + "26" : c.surface2, 
            ...
            <div style={{ 
              ...
              <Paperclip size={14} color={c.sub} style={{ flexShrink: 0 }} />
              <span style={{ flex: 1, fontSize: 12, color: c.muted, minWidth: 0 }}>
                Write a message…
              </span>
              <Send size={14} color={violet} style={{ flexShrink: 0 }} />
            </div>
          </div>
        )}
      </div>
  ...
  return (
    <div className="trys-root" style={{ background: c.bg, width: "100%", minHeight: "100vh", display: "flex", justifyContent: "center" }}>
      <GlobalStyle />
      <div style={{ width: "100%", maxWidth: 428, minHeight: "100vh", background: c.bg, position: "relative", display: "flex", flexDirection: "column" }}>
        ...
        <div key={view} className="screen-enter" style={{ flex: 1, paddingBottom: 12 }}>
          <Current />
        </div>

        {/* bottom tab bar */}
        <div style={{ position: "sticky", bottom: 0, background: dark ? "#0E0E11" : "#FFFFFF", borderTop: `1px solid ${c.border}`, display: "flex", padding: "9px 6px 16px", flexShrink: 0 }}>
